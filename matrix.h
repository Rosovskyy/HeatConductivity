...
//    Matrix createNewMatrix(int rows_st, int row_fin){
//        Matrix newmtrx(row_fin-rows_st, getAmountOfCols());
//        for (int i=0; i < (row_fin-rows_st); ++i){
//            for (int j=0; j < getAmountOfCols(); ++j){
//                double newVal = getEl(i,j);
//                newmtrx.setEl(newVal, i, j);
//            }
//        }
//        return newmtrx;
//    }
